...
namespace Business
{
    ...
    public class ZQ_BankselfRealTimePayment : GjjBusinessSuper
    {
        ...
        private string ZQ_ZhiQuZhiFuBenHangMessage(byte[] recvBytes)
        {
            ...
            this.je = Encoding.Default.GetString(BusinessTools.SubBytesArray(recvBytes, 324, 12)).TrimEnd();
            this.beiz = Encoding.Default.GetString(BusinessTools.SubBytesArray(recvBytes, 336, 60)).TrimEnd();
